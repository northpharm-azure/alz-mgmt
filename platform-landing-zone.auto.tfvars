...
custom_replacements = {
  ...
  */
  names = {
    ...
    defender_email_security_contact = "ictsecurity@northpharm.com.au"
    ...
    # IP Ranges Primary
    # Regional Address Space: 10.225.0.0/16
    primary_hub_address_space                          = "10.225.0.0/24"
    primary_sidecar_virtual_network_address_space      = "10.225.4.0/22"
    primary_bastion_subnet_address_prefix              = "10.225.4.0/26"
    primary_private_dns_resolver_subnet_address_prefix = "10.225.4.64/28"
  }
